...
<!-- Mirrored from www.wrraptheme.com/templates/compass/html/sign-in.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 12 Dec 2019 12:36:06 GMT -->
<head>
<meta charset="utf-8">
    ...
    <div class="container">        
        ...
        <div class="navbar-collapse">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link btn btn-primary btn-round" href="register.php">SIGN UP</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="container">
        <div class="col-md-12 content-center">
            <div class="card-plain">
                <form class="form" method="post" action="mainlogin.php">
                    <div class="header">
